<?php 
    ...
    if(isset($_POST['id_categoria']) && !empty($_POST["id_categoria"])) {
        ...
        $sqlsubcat = "select * from tbl_sub_categoria tsb where 
        tsb.id_categoria=$id_cat and ativacao=1 order by sub_categoria asc";
        ...
        */
        if($row_count > 0) {
            ...
            while($rssubcat=mysqli_fetch_assoc($sltsubcat)) {
                ...
                echo(utf8_encode('<option value="'.$rssubcat['id_sub_categoria'].'">'
