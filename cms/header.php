    ...
    <?php 
        ...
        if($_SESSION['nivel'] == 28) {
            $disable_to_catalog = "hidden";
        } else if($_SESSION['nivel'] == 26) {
            $disable_to_ob = "hidden";
        } 
    ?>
            <div id="containerCMS">
            <header id="headerCMS">
              ...
              <nav id="menuCMS">
                  ...
                  <ul id="menu-header">
                      ...
                      <li class="itemcms" <?php echo(@$disable_to_catalog)?>>
                       ...
                       <li class="itemcms"  <?php echo(@$disable_to_ob)?>>
